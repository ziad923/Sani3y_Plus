        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTrusted = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateJobDone = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreviousWorks_AspNetUsers_CraftsmanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MalfunctionImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_AspNetUsers_CraftsmanId",
                        column: x => x.CraftsmanId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_CraftsmanId",
                        column: x => x.CraftsmanId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Adminn", null, "Admin", "ADMIN" },
                    { "Craftsmann", null, "Craftsman", "CRAFTSMAN" },
                    { "Userr", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreviousWorks_CraftsmanId",
                table: "PreviousWorks",
                column: "CraftsmanId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_CraftsmanId",
                table: "Ratings",
                column: "CraftsmanId");
